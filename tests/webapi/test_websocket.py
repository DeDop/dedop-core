...
class WebSocketServiceTest(unittest.TestCase):
    ...
    def test_config_management(self):
        ...
        self.assertEqual(versions['cnf_version'], 1)
        ...
        self.assertEqual(len(cryosat_configs['chd']), 13)
        ...
        self.assertEqual(len(cryosat_configs['cnf']), 25)
        self.assertEqual(cryosat_configs['cnf']['flag_cal2_correction_cnf']['value'], False)
