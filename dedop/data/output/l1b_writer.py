...
class L1BWriter(NetCDFWriter):
    ...
    def write_record(self, surface_location_data: SurfaceData) -> None:
        ...
        super().write_record(
            ...
            nav_bul_coarse_time_l1b_echo_sar_ku=None,  # closest_burst.nav_bul_coarse_time,
            nav_bul_fine_time_l1b_echo_sar_ku=None,  # closest_burst.nav_bul_fine_time,
            ...
            agc_cor_ku_l1b_echo_sar_ku=None,  # closest_burst.agc_cor_ku,
